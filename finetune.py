...
dataset_name = "finetuning_data.jsonl"
...
def main():
    ...
    trainer = SFTTrainer(
        ...
        dataset_text_field="prompt", # Using prompt as the text field
    ...
    # Save trained model
    print(f"Saving trained model to '{new_model}'...")
    trainer.model.save_pretrained(new_model)
    
    # Merge and save the fine-tuned model
    # This is commented out as it requires more memory and is not always necessary
    # print("Merging and saving the full model...")
